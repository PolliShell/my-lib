...
const addBook = async (req, res) => {
    ...
    try {
        const result = await addBookToDatabase(title, description, publicationYear, coverImageUrl, author_id);
...
async function addBookToDatabase(title, description, publicationYear, coverImageUrl, author_id) {
    const query = {
